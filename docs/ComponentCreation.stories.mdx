...
type MyButtonPropsType = FC<MyButtonProps>['arguments'] 
...
type MyCardPropsType = FC<MyCardProps>['arguments'] 
...
type MyButtonPropsType = FC<MyButtonProps>['arguments'] 
type MyButtonTransformedPropsType = FC<MyButtonTransormedProps>['arguments']
